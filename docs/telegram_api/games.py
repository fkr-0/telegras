...
class Game(BaseModel):
    ...
    text: None | str = Field(default=None, description="Optional . Brief description of the game or high scores included in the game message. Can be automatically edited to include current high scores for the game when the bot calls setGameScore , or manually edited using editMessageText . 0-4096 characters.")
    text_entities: "None | list[MessageEntity]" = Field(default=None, description="Optional . Special entities that appear in text , such as usernames, URLs, bot commands, etc.")
    animation: "None | Animation" = Field(default=None, description="Optional . Animation that will be displayed in the game message in chats. Upload via BotFather")
